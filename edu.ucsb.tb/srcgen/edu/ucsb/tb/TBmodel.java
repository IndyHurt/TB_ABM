...
public class TBmodel extends Scape
	...
	protected void createChartViews() {
		...
		individual.setTreatmentStatus(TreatmentStatusEnum.clinicalTreatment);
		chart.addSeries(
		...
		chart.addSeries(
				"Count Individual HIV Negative HIV Status",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setHIVStatus(HIVStatusEnum.hIVPositive);
		chart.addSeries(
				"Count Individual HIV Positive HIV Status",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setSmoking(SmokingEnum.nonSmoker);
		chart.addSeries(
				"Count Individual Non Smoker Smoking",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setSmoking(SmokingEnum.smoker);
		chart.addSeries(
				"Count Individual Smoker Smoking",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setGender(GenderEnum.female);
		chart.addSeries(
				"Count Individual Female Gender",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setGender(GenderEnum.male);
		chart.addSeries(
				"Count Individual Male Gender",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setComplianceBehavior(ComplianceBehaviorEnum.neverCompliant);
		chart.addSeries(
		...
		chart.addSeries(
				"Count Individual Nourished Nutrition",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));

		individual.setNutrition(NutritionEnum.malnourished);
		chart.addSeries(
				"Count Individual Malnourished Nutrition",
				getInferredChartColor(individual,
						individualStyle2DColorProvider));
	...
	public IGraphicsAdapter getGraphicsAdapter() {
		return TBmodelGraphicsAdapter.getDefault();
	}
	...
	public static void main(String[] args) {
		(new NonGraphicRunner()).openInstance("edu.ucsb.tb.TBmodel");
	}
