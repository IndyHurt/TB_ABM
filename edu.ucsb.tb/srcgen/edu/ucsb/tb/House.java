...
/**
 * <!-- begin-user-doc -->
 * House Java Implementation.
 * 
 * Generated by AMF for model: TBmodel.metaabm in project: edu.ucsb.tb 
 * <!-- end-user-doc -->
 * @generated
 */
public class House extends CellOccupant implements IAgentChildProvider {
	...
	public void intializeNonFramework() {
		...
		if (house != null) {
			if (getHostScape() != ((Agent) house).getScape()) {
				die();
				getTBmodel().getHouseScape().add(this);
			}
